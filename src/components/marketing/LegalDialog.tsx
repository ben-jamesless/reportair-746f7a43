...
const TermsContent = () => (
  <div className="space-y-3">
    ...
    <p>Welcome to BuildFolder. By accessing or using our service you agree to be bound by these Terms & Conditions. Please read them carefully.</p>
    <LegalH2>1. Use of the service</LegalH2>
    <p>BuildFolder provides photo capture, organisation, and reporting tools for event production teams. You agree to use the service only for lawful purposes and in accordance with these terms.</p>
    ...
    <p>You retain ownership of all photos, notes, and content you upload. You grant BuildFolder a limited licence to host and process this content solely to deliver the service to you.</p>
    ...
    <p>The service is provided "as is" without warranties of any kind. BuildFolder is not liable for indirect or consequential damages arising from use of the service.</p>
...
const PrivacyContent = () => (
  <div className="space-y-3">
    <p className="text-xs" style={{ color: BRAND.mist }}>Last updated: {new Date().toLocaleDateString(undefined, { year: "numeric", month: "long", day: "numeric" })}</p>
    <p>This Privacy Policy explains how BuildFolder collects, uses, and protects your information when you use our service.</p>
    ...
    <p>To provide, maintain, and improve BuildFolder, to process payments, to communicate service updates, and to keep the platform secure.</p>
