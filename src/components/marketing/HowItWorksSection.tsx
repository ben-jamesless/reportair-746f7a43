...
const HowItWorksSection = () => {
  ...
  return (
    <section id="how-it-works" style={{ background: "#0F1417", color: "#fff", overflowX: "hidden" }}>
      ...
      <div className="hiw-scope" style={{ padding: "86px 48px 103px", maxWidth: 1200, margin: "0 auto" }}>
        {/* Header */}
...
const ExportPanel = ({ onRestart }: { onRestart: () => void }) => (
  <>
    ...
    <GraphicPanel>
      ...
      <div className="hiw-channel-row" style={{ display: "flex", gap: 8, alignItems: "center" }}>
