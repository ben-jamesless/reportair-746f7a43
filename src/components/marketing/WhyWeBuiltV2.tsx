...
const WhyWeBuiltV2 = () => (
  <section className="why-v2">
    ...
    <div className="card">
      <p className="copy">
        Photos are how a build gets shared, but come reporting they are lost to WhatApp threads, camera roles or drives with no organisation. So <span className="accent">we built the platform we always wanted,</span> a place to store, share and review project progress.
      </p>
    </div>
  </section>
);
