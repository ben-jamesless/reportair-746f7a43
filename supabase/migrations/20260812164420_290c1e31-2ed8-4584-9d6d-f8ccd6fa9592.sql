ALTER TABLE public.photos ADD COLUMN IF NOT EXISTS is_reference boolean NOT NULL DEFAULT false;
CREATE INDEX IF NOT EXISTS photos_project_reference_idx ON public.photos (project_id) WHERE is_reference;
...
AS $function$
  ...
  FROM public.photos
  WHERE project_id = _project_id AND is_reference = false;
$function$;
